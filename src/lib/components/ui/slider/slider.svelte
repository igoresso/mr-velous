...
>
	{#snippet children({ thumbs })}
		<span
			...
			class={cn(
				'bg-muted relative flex-1 overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5'
			)}
		>
