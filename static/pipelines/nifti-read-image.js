var niftiReadImage = (() => {
	...
	return async function (moduleArg = {}) {
		...
		var wasmBinaryFile;
		if (Module['locateFile']) {
			wasmBinaryFile = 'nifti-read-image.wasm';
			if (!isDataURI(wasmBinaryFile)) {
				wasmBinaryFile = locateFile(wasmBinaryFile);
			}
		} else {
			wasmBinaryFile = new URL('nifti-read-image.wasm', import.meta.url).href;
		}
		...
		var _main = (Module['_main'] = (a0, a1) =>
			(_main = Module['_main'] = wasmExports['A'])(a0, a1));
		var _itk_wasm_input_array_alloc = (Module['_itk_wasm_input_array_alloc'] = (a0, a1, a2, a3) =>
			(_itk_wasm_input_array_alloc = Module['_itk_wasm_input_array_alloc'] = wasmExports['B'])(
				a0,
				a1,
				a2,
				a3
		...
		var _itk_wasm_input_json_alloc = (Module['_itk_wasm_input_json_alloc'] = (a0, a1, a2) =>
			(_itk_wasm_input_json_alloc = Module['_itk_wasm_input_json_alloc'] = wasmExports['C'])(
				a0,
				a1,
				a2
			));
		var _itk_wasm_output_json_address = (Module['_itk_wasm_output_json_address'] = (a0, a1) =>
			(_itk_wasm_output_json_address = Module['_itk_wasm_output_json_address'] = wasmExports['D'])(
				a0,
				a1
			));
		var _itk_wasm_output_json_size = (Module['_itk_wasm_output_json_size'] = (a0, a1) =>
			(_itk_wasm_output_json_size = Module['_itk_wasm_output_json_size'] = wasmExports['E'])(
				a0,
				a1
			));
		var _itk_wasm_output_array_address = (Module['_itk_wasm_output_array_address'] = (a0, a1, a2) =>
			(_itk_wasm_output_array_address = Module['_itk_wasm_output_array_address'] =
				wasmExports['F'])(a0, a1, a2));
		var _itk_wasm_output_array_size = (Module['_itk_wasm_output_array_size'] = (a0, a1, a2) =>
			(_itk_wasm_output_array_size = Module['_itk_wasm_output_array_size'] = wasmExports['G'])(
				a0,
				a1,
				a2
			));
		var _itk_wasm_free_all = (Module['_itk_wasm_free_all'] = () =>
			(_itk_wasm_free_all = Module['_itk_wasm_free_all'] = wasmExports['H'])());
