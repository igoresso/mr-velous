var readImageDicomFileSeries = (() => {
	...
	return async function (moduleArg = {}) {
		...
		var wasmBinaryFile;
		if (Module['locateFile']) {
			wasmBinaryFile = 'read-image-dicom-file-series.wasm';
			if (!isDataURI(wasmBinaryFile)) {
				wasmBinaryFile = locateFile(wasmBinaryFile);
			}
		} else {
			wasmBinaryFile = new URL('read-image-dicom-file-series.wasm', import.meta.url).href;
		}
		...
		var _itk_wasm_input_array_alloc = (Module['_itk_wasm_input_array_alloc'] = (a0, a1, a2, a3) =>
			(_itk_wasm_input_array_alloc = Module['_itk_wasm_input_array_alloc'] = wasmExports['P'])(
				a0,
				a1,
				a2,
				a3
		...
		var _itk_wasm_input_json_alloc = (Module['_itk_wasm_input_json_alloc'] = (a0, a1, a2) =>
			(_itk_wasm_input_json_alloc = Module['_itk_wasm_input_json_alloc'] = wasmExports['Q'])(
				a0,
				a1,
				a2
			));
		var _itk_wasm_output_json_address = (Module['_itk_wasm_output_json_address'] = (a0, a1) =>
			(_itk_wasm_output_json_address = Module['_itk_wasm_output_json_address'] = wasmExports['R'])(
				a0,
				a1
			));
		var _itk_wasm_output_json_size = (Module['_itk_wasm_output_json_size'] = (a0, a1) =>
			(_itk_wasm_output_json_size = Module['_itk_wasm_output_json_size'] = wasmExports['S'])(
				a0,
				a1
			));
		var _itk_wasm_output_array_address = (Module['_itk_wasm_output_array_address'] = (a0, a1, a2) =>
			(_itk_wasm_output_array_address = Module['_itk_wasm_output_array_address'] =
				wasmExports['T'])(a0, a1, a2));
		var _itk_wasm_output_array_size = (Module['_itk_wasm_output_array_size'] = (a0, a1, a2) =>
			(_itk_wasm_output_array_size = Module['_itk_wasm_output_array_size'] = wasmExports['U'])(
				a0,
				a1,
				a2
			));
		var _itk_wasm_free_all = (Module['_itk_wasm_free_all'] = () =>
			(_itk_wasm_free_all = Module['_itk_wasm_free_all'] = wasmExports['V'])());
		var _setThrew = (a0, a1) => (_setThrew = wasmExports['X'])(a0, a1);
		...
		function applySignatureConversions(wasmExports) {
			...
			wasmExports['_'] = makeWrapper_pp(wasmExports['_']);
			return wasmExports;
		}
